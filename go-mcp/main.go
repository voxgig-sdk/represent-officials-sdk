// Command RepresentOfficials-mcp is an MCP server exposing the RepresentOfficials
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RepresentOfficials_list  — list records of an entity
//	RepresentOfficials_load  — load a single record of an entity
//
