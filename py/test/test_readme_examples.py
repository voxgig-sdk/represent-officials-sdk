# RepresentOfficials SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RepresentOfficialsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RepresentOfficialsSDK(...) and RepresentOfficialsSDK.test(...) become
#      RepresentOfficialsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "representofficials_sdk"
_SDK_CLASS = "RepresentOfficialsSDK"
