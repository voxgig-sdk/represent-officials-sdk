...
from representofficials_sdk.utility import register

# Load features
from representofficials_sdk.feature.base_feature import RepresentOfficialsBaseFeature
from representofficials_sdk.features import _has_feature, _make_feature
...
class RepresentOfficialsSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "RepresentOfficialsSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RepresentOfficialsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Boundary(self, data=None) -> "BoundaryEntity":
        ...
        from representofficials_sdk.entity.boundary_entity import BoundaryEntity
    ...
    def BoundarySet(self, data=None) -> "BoundarySetEntity":
        ...
        from representofficials_sdk.entity.boundary_set_entity import BoundarySetEntity
