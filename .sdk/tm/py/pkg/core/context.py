...
from projectname_sdk.core.control import RepresentOfficialsControl
...
class RepresentOfficialsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = RepresentOfficialsControl()
        ...
        if isinstance(sp, RepresentOfficialsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RepresentOfficialsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RepresentOfficialsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return RepresentOfficialsOperation({})
    ...
    def make_error(self, code, msg):
        return RepresentOfficialsError(code, msg, self)
