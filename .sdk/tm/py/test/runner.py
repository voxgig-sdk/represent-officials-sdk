...
class RepresentOfficialsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RepresentOfficialsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = RepresentOfficialsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = RepresentOfficialsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
