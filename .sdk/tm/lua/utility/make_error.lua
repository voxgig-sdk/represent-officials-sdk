...
local function make_error_util(ctx, err)
  ...
  local msg = "RepresentOfficialsSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = RepresentOfficialsError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == RepresentOfficialsError then
