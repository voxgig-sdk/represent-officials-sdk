...
// RepresentOfficials SDK utility type

class RepresentOfficialsUtility
{
    ...
    public static function copy(RepresentOfficialsUtility $src): RepresentOfficialsUtility
    {
        $u = new RepresentOfficialsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
