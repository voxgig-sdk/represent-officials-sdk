...
// RepresentOfficials SDK utility: graphql
//
...
class RepresentOfficialsGraphql
{
    ...
    // equivalent.
    public static function body(RepresentOfficialsContext $ctx): mixed
    {
    ...
    public static function errors(RepresentOfficialsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
