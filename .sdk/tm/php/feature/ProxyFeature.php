...
// RepresentOfficials SDK proxy feature
...
class RepresentOfficialsProxyFeature extends RepresentOfficialsBaseFeature
{
    ...
    public function init(RepresentOfficialsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RepresentOfficialsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
