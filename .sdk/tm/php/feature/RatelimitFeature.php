...
// RepresentOfficials SDK ratelimit feature
...
class RepresentOfficialsRatelimitFeature extends RepresentOfficialsBaseFeature
{
    ...
    private function _acquire(RepresentOfficialsContext $ctx): void
    {
    ...
    private function _track(RepresentOfficialsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
