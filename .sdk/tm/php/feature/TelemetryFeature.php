...
// RepresentOfficials SDK telemetry feature
...
class RepresentOfficialsTelemetryFeature extends RepresentOfficialsBaseFeature
{
    ...
    private function _close(RepresentOfficialsContext $ctx, bool $ok): void
    {
