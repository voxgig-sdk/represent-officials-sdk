...
// RepresentOfficials SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RepresentOfficialsTestFeature extends RepresentOfficialsBaseFeature
{
    ...
    public function init(RepresentOfficialsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RepresentOfficialsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = RepresentOfficialsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RepresentOfficialsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RepresentOfficialsContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = RepresentOfficialsParam::call($ctx, $k);
