...
// RepresentOfficials SDK rbac feature
...
class RepresentOfficialsRbacFeature extends RepresentOfficialsBaseFeature
{
    ...
    private function _required(RepresentOfficialsContext $ctx): ?string
    {
    ...
    private function _reject(RepresentOfficialsContext $ctx, string $required): void
    {
    ...
    private function _track(RepresentOfficialsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
