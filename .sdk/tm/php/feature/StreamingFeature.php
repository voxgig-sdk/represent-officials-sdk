...
// RepresentOfficials SDK streaming feature
...
class RepresentOfficialsStreamingFeature extends RepresentOfficialsBaseFeature
{
    ...
    private function _iterate(RepresentOfficialsResult $result): \Generator
    {
    ...
    private function _streamable(RepresentOfficialsContext $ctx): bool
    {
