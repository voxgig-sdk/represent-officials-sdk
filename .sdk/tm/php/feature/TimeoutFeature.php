...
// RepresentOfficials SDK timeout feature
...
class RepresentOfficialsTimeoutFeature extends RepresentOfficialsBaseFeature
{
    ...
    private function _with_timeout(RepresentOfficialsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RepresentOfficialsContext $_ctx, float $ms): void
    {
        $client = $this->client;
