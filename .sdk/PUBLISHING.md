...
|---|---|---|
| `ts/` | @voxgig-sdk/represent-officials-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/represent-officials-sdk \
      --repository voxgig-sdk/represent-officials-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/represent-officials-sdk` shows it, and
`npm trust revoke @voxgig-sdk/represent-officials-sdk --id=<id>` removes it.
