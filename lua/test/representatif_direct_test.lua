...
describe("RepresentatifDirect", function()
  it("should direct-list-representatif", function()
    local setup = representatif_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-representatif", setup.live and "live" or "unit")
  ...
  it("should direct-load-representatif", function()
    local setup = representatif_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-representatif", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function representatif_direct_setup(mockres)
