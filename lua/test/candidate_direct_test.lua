...
describe("CandidateDirect", function()
  it("should direct-list-candidate", function()
    local setup = candidate_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-candidate", setup.live and "live" or "unit")
...
function candidate_direct_setup(mockres)
