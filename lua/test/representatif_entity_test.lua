...
describe("RepresentatifEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set REPRESENTOFFICIALS_TEST_REPRESENTATIF_ENTID JSON to run live")
      return
    end
...
function representatif_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("REPRESENTOFFICIALS_TEST_REPRESENTATIF_ENTID")
