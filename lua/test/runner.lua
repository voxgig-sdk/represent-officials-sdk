...
function runner.env_override(m)
  local live = runner.getenv("REPRESENT_OFFICIALS_TEST_LIVE")
  local override = runner.getenv("REPRESENT_OFFICIALS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("REPRESENT_OFFICIALS_TEST_EXPLAIN")
