...
local RepresentatifEntity = {}
RepresentatifEntity.__index = RepresentatifEntity


function RepresentatifEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepresentatifEntity)
  self._name = "representatif"
  self._client = client
...
function RepresentatifEntity:get_name()
  return self._name
end


function RepresentatifEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepresentatifEntity.new(self._client, opts)
end
...
function RepresentatifEntity:mark_deleted()
  self._deleted = true
end


function RepresentatifEntity:deleted()
  return true == self._deleted
end


function RepresentatifEntity:data_set(args)
  if args ~= nil then
...
function RepresentatifEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepresentatifEntity:match_set(args)
  if args ~= nil then
...
function RepresentatifEntity:match_get()
...
function RepresentatifEntity:stream(action, args, callopts)
...
---@param reqmatch RepresentatifLoadMatch
---@param ctrl? table
---@return Representatif
---@return string? err
function RepresentatifEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch RepresentatifListMatch
---@param ctrl? table
---@return Representatif[]
---@return string? err
function RepresentatifEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function RepresentatifEntity:_run_op(ctx, post_done)
  local utility = self._utility
