...
local BoundarySetEntity = {}
BoundarySetEntity.__index = BoundarySetEntity


function BoundarySetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BoundarySetEntity)
  self._name = "boundary_set"
  self._client = client
...
function BoundarySetEntity:get_name()
  return self._name
end


function BoundarySetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BoundarySetEntity.new(self._client, opts)
end
...
function BoundarySetEntity:mark_deleted()
  self._deleted = true
end


function BoundarySetEntity:deleted()
  return true == self._deleted
end


function BoundarySetEntity:data_set(args)
  if args ~= nil then
...
function BoundarySetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BoundarySetEntity:match_set(args)
  if args ~= nil then
...
function BoundarySetEntity:match_get()
...
function BoundarySetEntity:stream(action, args, callopts)
...
function BoundarySetEntity:_run_op(ctx, post_done)
  local utility = self._utility
