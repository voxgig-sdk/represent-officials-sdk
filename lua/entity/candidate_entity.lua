...
CandidateEntity.__index = CandidateEntity


function CandidateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CandidateEntity)
...
function CandidateEntity:get_name()
  return self._name
end


function CandidateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CandidateEntity.new(self._client, opts)
end
...
function CandidateEntity:mark_deleted()
  self._deleted = true
end


function CandidateEntity:deleted()
  return true == self._deleted
end


function CandidateEntity:data_set(args)
  if args ~= nil then
...
function CandidateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CandidateEntity:match_set(args)
  if args ~= nil then
...
function CandidateEntity:match_get()
...
function CandidateEntity:stream(action, args, callopts)
...
---@param reqmatch CandidateListMatch
---@param ctrl? table
---@return Candidate[]
---@return string? err
function CandidateEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CandidateEntity:_run_op(ctx, post_done)
  local utility = self._utility
