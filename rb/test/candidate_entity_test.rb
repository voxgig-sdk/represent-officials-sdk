...
class CandidateEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set REPRESENTOFFICIALS_TEST_CANDIDATE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def candidate_basic_setup(extra)
  ...
  entid_env_raw = ENV["REPRESENTOFFICIALS_TEST_CANDIDATE_ENTID"]
