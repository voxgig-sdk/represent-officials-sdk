...
class BoundaryEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set REPRESENTOFFICIALS_TEST_BOUNDARY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def boundary_basic_setup(extra)
  ...
  entid_env_raw = ENV["REPRESENTOFFICIALS_TEST_BOUNDARY_ENTID"]
