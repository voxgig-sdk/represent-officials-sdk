...
class RepresentativeSetEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set REPRESENT_OFFICIALS_TEST_REPRESENTATIVE_SET_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def representative_set_basic_setup(extra)
  ...
  entid_env_raw = ENV["REPRESENT_OFFICIALS_TEST_REPRESENTATIVE_SET_ENTID"]
