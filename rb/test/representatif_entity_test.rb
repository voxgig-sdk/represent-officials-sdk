...
class RepresentatifEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set REPRESENTOFFICIALS_TEST_REPRESENTATIF_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def representatif_basic_setup(extra)
  ...
  entid_env_raw = ENV["REPRESENTOFFICIALS_TEST_REPRESENTATIF_ENTID"]
