...
#      offline in seeded test mode (RepresentOfficialsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RepresentOfficials_sdk.rb")
  SDK_CLASS = "RepresentOfficialsSDK"
  ...
  SDK_BASE = "RepresentOfficials_sdk"
