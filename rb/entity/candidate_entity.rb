...
class CandidateEntity
  ...
  def make
    opts = @_entopts.dup
    CandidateEntity.new(@_client, opts)
  end
  ...
  # @return [Candidate, Hash] the current Candidate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Candidate fields)
  def match_get
  ...
  #
  # @param reqmatch [CandidateListMatch, Hash, nil] match filter (any subset of
  #   Candidate fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Candidate>, Array] the matching Candidate items; raises RepresentOfficialsError on failure
