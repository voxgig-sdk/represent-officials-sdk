...
class CandidateEntity extends RepresentOfficialsEntityBase_1.RepresentOfficialsEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'candidate';
        this.name_ = 'candidate';
        this.Name = 'Candidate';
    }
    make() {
        return new CandidateEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Candidate[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
...
//# sourceMappingURL=CandidateEntity.js.map