...
(0, node_test_1.describe)('BoundarySetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-boundary_set', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-boundary_set', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-boundary_set', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-boundary_set', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['REPRESENT_OFFICIALS_TEST_BOUNDARY_SET_ENTID'];
...
//# sourceMappingURL=BoundarySetDirect.test.js.map