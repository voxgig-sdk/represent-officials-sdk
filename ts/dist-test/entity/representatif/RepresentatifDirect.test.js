...
(0, node_test_1.describe)('RepresentatifDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-representatif', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-representatif', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-representatif', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-representatif', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['REPRESENT_OFFICIALS_TEST_REPRESENTATIF_ENTID'];
...
//# sourceMappingURL=RepresentatifDirect.test.js.map