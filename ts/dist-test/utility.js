...
function envOverride(m) {
    if ('TRUE' === process.env.REPRESENT_OFFICIALS_TEST_LIVE ||
        'TRUE' === process.env.REPRESENT_OFFICIALS_TEST_OVERRIDE) {
    ...
    m.REPRESENT_OFFICIALS_TEST_EXPLAIN = process.env.REPRESENT_OFFICIALS_TEST_EXPLAIN || m.REPRESENT_OFFICIALS_TEST_EXPLAIN;
    return m;
}
