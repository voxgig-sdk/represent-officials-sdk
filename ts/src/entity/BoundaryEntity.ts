...
class BoundaryEntity extends RepresentOfficialsEntityBase<Boundary> {
  ...
  make(this: BoundaryEntity) {
    return new BoundaryEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: BoundaryLoadMatch, ctrl?: Control): Promise<BoundaryEntity> {
  ...
  async list(this: any, reqmatch?: BoundaryListMatch, ctrl?: Control): Promise<BoundaryEntity[]> {
