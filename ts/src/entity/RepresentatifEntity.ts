...
class RepresentatifEntity extends RepresentOfficialsEntityBase<Representatif> {
  ...
  constructor(client: RepresentOfficialsSDK, entopts: any) {
    ...
    this.name = 'representatif'
    this.name_ = 'representatif'
    this.Name = 'Representatif'
  }


  make(this: RepresentatifEntity) {
    return new RepresentatifEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: RepresentatifLoadMatch, ctrl?: Control): Promise<RepresentatifEntity> {
  ...
  async list(this: any, reqmatch?: RepresentatifListMatch, ctrl?: Control): Promise<RepresentatifEntity[]> {
