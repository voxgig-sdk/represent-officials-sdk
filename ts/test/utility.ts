...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.REPRESENTOFFICIALS_TEST_LIVE ||
    'TRUE' === process.env.REPRESENTOFFICIALS_TEST_OVERRIDE
  ) {
  ...
  m.REPRESENTOFFICIALS_TEST_EXPLAIN = process.env.REPRESENTOFFICIALS_TEST_EXPLAIN || m.REPRESENTOFFICIALS_TEST_EXPLAIN
