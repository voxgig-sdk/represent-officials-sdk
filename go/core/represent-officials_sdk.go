...
type RepresentOfficialsSDK struct {
	Mode     string
...
func (sdk *RepresentOfficialsSDK) OptionsMap() map[string]any {
...
func (sdk *RepresentOfficialsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RepresentOfficialsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RepresentOfficialsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RepresentOfficialsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RepresentOfficialsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RepresentOfficialsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RepresentOfficialsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RepresentOfficialsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RepresentOfficialsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RepresentOfficialsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RepresentOfficialsSDK {
	...
	sdk := NewRepresentOfficialsSDK(sdkopts)
	sdk.Mode = "test"
