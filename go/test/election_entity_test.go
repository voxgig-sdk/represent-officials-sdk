...
func TestElectionEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set REPRESENT_OFFICIALS_TEST_ELECTION_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func electionBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("REPRESENT_OFFICIALS_TEST_ELECTION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["REPRESENT_OFFICIALS_TEST_ELECTION_ENTID"])
