...
func TestBoundarySetEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set REPRESENTOFFICIALS_TEST_BOUNDARY_SET_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func boundary_setBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("REPRESENTOFFICIALS_TEST_BOUNDARY_SET_ENTID")
	...
	idmapResolved := core.ToMapAny(env["REPRESENTOFFICIALS_TEST_BOUNDARY_SET_ENTID"])
