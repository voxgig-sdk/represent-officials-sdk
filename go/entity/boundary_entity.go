...
func NewBoundaryEntity(client *core.RepresentOfficialsSDK, entopts map[string]any) *BoundaryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BoundaryEntity) GetName() string { return e.name }
...
func (e *BoundaryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BoundaryEntity) Deleted() bool {
	return e.deleted
}


func (e *BoundaryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBoundaryEntity(e.client, opts)
}

func (e *BoundaryEntity) Data(args ...any) any {
...
func (e *BoundaryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *BoundaryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BoundaryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *BoundaryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BoundaryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BoundaryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BoundaryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
