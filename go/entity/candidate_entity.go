...
func NewCandidateEntity(client *core.RepresentOfficialsSDK, entopts map[string]any) *CandidateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CandidateEntity) GetName() string { return e.name }
...
func (e *CandidateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CandidateEntity) Deleted() bool {
	return e.deleted
}


func (e *CandidateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCandidateEntity(e.client, opts)
}

func (e *CandidateEntity) Data(args ...any) any {
...
func (e *CandidateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Candidate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CandidateEntity) DataTyped(data ...Candidate) Candidate {
	if len(data) > 0 {
		return typedFrom[Candidate](e.Data(asMap(data[0])))
	}
	return typedFrom[Candidate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Candidate (all fields
// optional at the wire level).
func (e *CandidateEntity) MatchTyped(match ...Candidate) Candidate {
	if len(match) > 0 {
		return typedFrom[Candidate](e.Match(asMap(match[0])))
	}
	return typedFrom[Candidate](e.Match())
}
...
func (e *CandidateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CandidateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CandidateEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CandidateListMatch and returns []Candidate. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CandidateEntity) ListTyped(reqmatch CandidateListMatch, ctrl map[string]any) ([]Candidate, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Candidate](res), nil
}



func (e *CandidateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CandidateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CandidateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CandidateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
