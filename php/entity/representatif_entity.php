...
// RepresentOfficials SDK Representatif entity
...
class RepresentatifEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RepresentatifEntity($this->_client, $opts);
    }

    /**
     * @param Representatif|array $args Representatif data (assoc-array) to store.
     */
    ...
    /**
     * @return Representatif|array The current Representatif data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Representatif fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Representatif fields).
     */
     ...
     *
     * @param RepresentatifLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepresentatifLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Representatif|array The loaded Representatif as an assoc-array at the
     ...
     *
     * @param RepresentatifListMatch|array|null $reqmatch Match filter (any subset
     *   of Representatif fields) as an assoc-array; RepresentatifListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Representatif[]|array A list of Representatif items as assoc-arrays at
