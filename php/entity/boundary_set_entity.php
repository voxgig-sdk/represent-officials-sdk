...
// RepresentOfficials SDK BoundarySet entity
...
class BoundarySetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BoundarySetEntity($this->_client, $opts);
    }

    /**
     * @param BoundarySet|array $args BoundarySet data (assoc-array) to store.
     */
    ...
    /**
     * @return BoundarySet|array The current BoundarySet data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BoundarySet fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BoundarySet fields).
     */
     ...
     *
     * @param BoundarySetLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BoundarySetLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoundarySet|array The loaded BoundarySet as an assoc-array at the
     ...
     *
     * @param BoundarySetListMatch|array|null $reqmatch Match filter (any subset
     *   of BoundarySet fields) as an assoc-array; BoundarySetListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoundarySet[]|array A list of BoundarySet items as assoc-arrays at
