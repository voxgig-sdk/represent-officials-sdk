...
// RepresentOfficials SDK Candidate entity
...
class CandidateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CandidateEntity($this->_client, $opts);
    }

    /**
     * @param Candidate|array $args Candidate data (assoc-array) to store.
     */
    ...
    /**
     * @return Candidate|array The current Candidate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Candidate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Candidate fields).
     */
    ...
    /**
     * List Candidate items matching the given filter.
     *
     * @param CandidateListMatch|array|null $reqmatch Match filter (any subset
     *   of Candidate fields) as an assoc-array; CandidateListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Candidate[]|array A list of Candidate items as assoc-arrays at
