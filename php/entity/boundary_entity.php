...
class BoundaryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BoundaryEntity($this->_client, $opts);
    }

    /**
     * @param Boundary|array $args Boundary data (assoc-array) to store.
     */
    ...
    /**
     * @return Boundary|array The current Boundary data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Boundary fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Boundary fields).
     */
    ...
    /**
     * Load a single Boundary.
     *
     * @param BoundaryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BoundaryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Boundary|array The loaded Boundary as an assoc-array at the
    ...
    /**
     * List Boundary items matching the given filter.
     *
     * @param BoundaryListMatch|array|null $reqmatch Match filter (any subset
     *   of Boundary fields) as an assoc-array; BoundaryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Boundary[]|array A list of Boundary items as assoc-arrays at
