...
// RepresentOfficials SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RepresentOfficialsSDK::test)
...
{
    private const SDK_CLASS = 'RepresentOfficialsSDK';
    ...
    private const SDK_BASE = 'representofficials_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../representofficials_sdk.php';
