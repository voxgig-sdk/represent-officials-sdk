...
class RepresentOfficialsTestRunner
{
    ...
    {
        $live = self::getenv('REPRESENT_OFFICIALS_TEST_LIVE');
        $override = self::getenv('REPRESENT_OFFICIALS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('REPRESENT_OFFICIALS_TEST_EXPLAIN');
...
class_alias('RepresentOfficialsTestRunner', 'Runner');
class_alias('RepresentOfficialsHelpers', 'Helpers');
