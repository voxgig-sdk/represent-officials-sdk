...
class RepresentativeSetEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set REPRESENTOFFICIALS_TEST_REPRESENTATIVE_SET_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function representative_set_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("REPRESENTOFFICIALS_TEST_REPRESENTATIVE_SET_ENTID");
