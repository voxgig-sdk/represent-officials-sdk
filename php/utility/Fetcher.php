...
// RepresentOfficials SDK utility: fetcher

class RepresentOfficialsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RepresentOfficialsSDK/1.0)';
    ...
    public static function call(RepresentOfficialsContext $ctx, string $fullurl, array $fetchdef): array
    {
