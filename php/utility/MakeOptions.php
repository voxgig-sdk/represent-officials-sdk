...
// RepresentOfficials SDK utility: make_options

class RepresentOfficialsMakeOptions
{
    ...
    public static function call(RepresentOfficialsContext $ctx): array
    {
        ...
        //
        // `RepresentOfficialsSchema::optspec()` is built from the model:
        ...
        $optspec = RepresentOfficialsSchema::optspec();
