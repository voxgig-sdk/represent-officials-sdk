...
// RepresentOfficials SDK utility: result_basic

class RepresentOfficialsResultBasic
{
    public static function call(RepresentOfficialsContext $ctx): ?RepresentOfficialsResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof RepresentOfficialsError) ? $result->err->msg : (string)$result->err;
