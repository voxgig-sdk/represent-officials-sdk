...
// RepresentOfficials SDK clienttrack feature
...
class RepresentOfficialsClienttrackFeature extends RepresentOfficialsBaseFeature
{
    ...
    public function PostConstruct(RepresentOfficialsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RepresentOfficials-SDK';
