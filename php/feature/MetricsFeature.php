...
// RepresentOfficials SDK metrics feature
...
class RepresentOfficialsMetricsFeature extends RepresentOfficialsBaseFeature
{
    ...
    private function _record(RepresentOfficialsContext $ctx, bool $ok): void
    {
