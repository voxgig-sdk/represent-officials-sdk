...
// RepresentOfficials SDK debug feature
...
class RepresentOfficialsDebugFeature extends RepresentOfficialsBaseFeature
{
    ...
    private function _finish(RepresentOfficialsContext $ctx, bool $ok): void
    {
