...
// RepresentOfficials SDK netsim feature
...
class RepresentOfficialsNetsimFeature extends RepresentOfficialsBaseFeature
{
    ...
    private function _simulate(RepresentOfficialsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RepresentOfficialsContext $ctx, array $applied): void
    {
        $client = $this->client;
