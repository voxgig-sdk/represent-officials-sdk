...
// RepresentOfficials SDK audit feature
...
class RepresentOfficialsAuditFeature extends RepresentOfficialsBaseFeature
{
    ...
    private function _emit(RepresentOfficialsContext $ctx, string $outcome): void
    {
