...
// RepresentOfficials SDK cache feature
...
class RepresentOfficialsCacheFeature extends RepresentOfficialsBaseFeature
{
    ...
    private function _through(RepresentOfficialsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
