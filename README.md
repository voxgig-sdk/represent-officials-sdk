...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/represent-officials` | `npm install @voxgig-sdk/represent-officials` |
| Python | `voxgig-sdk-represent-officials` | `pip install voxgig-sdk-represent-officials` |
| PHP | `voxgig-sdk/represent-officials` | `composer require voxgig-sdk/represent-officials` |
| Golang | `github.com/voxgig-sdk/represent-officials-sdk/go` | `go get github.com/voxgig-sdk/represent-officials-sdk/go` |
| Ruby | `voxgig-sdk-represent-officials` | `gem install voxgig-sdk-represent-officials` |
| Lua | `voxgig-sdk-represent-officials` | `luarocks install voxgig-sdk-represent-officials` |
