...
This SDK exposes the API as a small set of **semantic entities** — Boundary, BoundarySet, Candidate, Election, PostalCode, Representatif and RepresentativeSet — that you
