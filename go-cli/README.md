...
AQL-driven CLI and REPL for the RepresentOfficials SDK. Positional arguments are
...
```sh
go build -o represent-officials-cli ./...
```
...
./represent-officials-cli load 1 boundary
./represent-officials-cli load '{id:1}' boundary
