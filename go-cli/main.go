// Command RepresentOfficials-cli is a CLI + REPL for the RepresentOfficials SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      REPRESENT_OFFICIALS_APIKEY (api key), REPRESENT_OFFICIALS_BASE (base url override)")
